...
--filter-tcp=25565 --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n4 --dpi-desync=multisplit --dpi-desync-split-seqovl=582 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="bin/tls_clienthello_4pda_to.bin" --new ^
