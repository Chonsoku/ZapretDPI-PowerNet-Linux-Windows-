# ZapretDPI-PowerNet
_Этот репозиторий также особенно орентирован на людей с провайдером 'PowerNet', т.к. блокировки у него более "мягкие", но тем самым - методы обхода немного отличаются от других провайдеров!_

Сам же репозиторий основан на этих проектах:
...
# | Далее идёт информация из репозитория Sergeydigl3... |
